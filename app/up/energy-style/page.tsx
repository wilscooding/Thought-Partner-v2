...
export default function UpEnergyStylePage() {
  ...
  const handleNext = () => {
    ...
    // Next page in sequence: Communication Style Page
    router.push("/up/comm-style");
  };
    ...
    <main className="light-bg-page">
      ...
      <div className="intro-shell">
        ...
        <div className="up-select-wrapper">
          ...
          >
            {selectedStyle || "Select your energy style"}
          </button>
